  ...
  <mj-body>
    <mj-section background-color="#121212" full-width="full-width">
      <mj-column>
        ...
        <mj-button href="${process.env.CLIENT_BASE_URL}/entry/change-password?token=${token}" border-radius="54px" font-family="Montserrat, Roboto, Arial" font-weight="600" inner-padding="16px 24px" font-size="16px" color="#121212" background-color="#A1D890">
          Reset password
        </mj-button>
        <mj-spacer height="30px" />
